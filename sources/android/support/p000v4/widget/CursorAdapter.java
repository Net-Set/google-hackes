...
import com.hacks.googhackslite.CustomDbAdapter;
...
public abstract class CursorAdapter extends BaseAdapter implements Filterable, CursorFilterClient {
    ...
    public void init(Context context, Cursor c, int flags) {
        ...
        this.mRowIDColumn = cursorPresent ? c.getColumnIndexOrThrow(CustomDbAdapter.KEY_ROWID) : -1;
        if ((flags & 2) == 2) {
    ...
    public Cursor swapCursor(Cursor newCursor) {
        ...
        if (newCursor != null) {
            ...
            this.mRowIDColumn = newCursor.getColumnIndexOrThrow(CustomDbAdapter.KEY_ROWID);
