...
public class ViewPager extends ViewGroup {
    ...
    /* renamed from: android.support.v4.view.ViewPager$DataSetObserver */
    ...
    public void populate() {
        ...
        if (this.mAdapter != null && !this.mPopulatePending && getWindowToken() != null) {
            ...
            int lastPos3 = this.mItems.size() > 0 ? ((ItemInfo) this.mItems.get(this.mItems.size() - 1)).position : -1;
            if (lastPos3 < endPos) {
            ...
            while (true) {
                if (i2 >= this.mItems.size()) {
                    break;
                } else if (((ItemInfo) this.mItems.get(i2)).position == this.mCurItem) {
                    curItem = (ItemInfo) this.mItems.get(i2);
                    break;
                } else {
                    i2++;
                }
            ...
            pagerAdapter.setPrimaryItem(this, i3, obj);
            this.mAdapter.finishUpdate(this);
            if (hasFocus()) {
